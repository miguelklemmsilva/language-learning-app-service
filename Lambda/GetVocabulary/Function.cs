...
namespace Lambda.GetVocabulary;
        ...
        APIGatewayHttpApiV2ProxyRequest apigProxyEvent, ILambdaContext context)
    {
        try
        {
            ...
            var body = JsonSerializer.Deserialize(apigProxyEvent.Body,
                LambdaFunctionJsonSerializerContext.Default.GetVocabularyRequest)!;
            
            var getVocabularyRequest = new GetVocabularyRequest
            {
            ...
            var vocabulary = await vocabularyService.GetUserVocabularyAsync(username, getVocabularyRequest.Language);
            
            return ResponseHelper.CreateSuccessResponse(vocabulary, typeof(IEnumerable<GetUserVocabularyResponse>));
        }
        catch (Exception e)
        {
...
[JsonSerializable(typeof(GetVocabularyRequest))]
